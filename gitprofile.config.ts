...
const CONFIG = {
  github: {
    username: 'umayanganacooray', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  seo: {
    title: 'Portfolio of Umayangana Cooray',
    description: '',
    imageURL: '',
  },
  social: {
    linkedin: 'umayangana-cooray',
    twitter: '',
    mastodon: '',
    researchGate: '',
    facebook: '',
  ...
  educations: [
    {
      ...
      degree: 'Reading BSc (Hons) in Software Engineering',
      from: '2022',
      to: 'Present',
    },
    {
  ...
  blog: {
    source: 'deploying-a-react-js-app-on-aws-ec2-with-domain-and-ssl-using-nginx', // medium | dev
